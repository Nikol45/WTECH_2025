<div class="admin-zone p-5 border rounded bg-white">
    ...
    <div class="mb-4 admin-products">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="{{ route('farms.create') }}" class="btn btn-secondary btn-sm d-flex align-items-center gap-1">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('farms.show', $farm->id) }}" class="admin-card p-3 flex-grow-1">
                                    <div class="row g-sm-4">
                                        <div class="col-sm-5">
                                            <img src="{{ asset($farm->image) }}" alt="{{ $farm->name }}" class="img-fluid rounded">
                                        </div>
    ...
    <div class="mb-4 package-products">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="{{ route('articles.create') }}" class="btn btn-secondary btn-sm d-flex align-items-center gap-1">
                <span class="material-icons">add</span>
                Pridať článok
            </a>
        </div>
                        ...
                        <div class="col flex-shrink-0">
                            <div class="d-flex align-items-start gap-2">
                                <div class="card text-start p-3">
                                    <img src="{{ asset($article->image) }}" alt="article image" class="card-img">
    ...
    <div class="mb-4 admin-products">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="{{ route('reviews.create') }}" class="btn btn-secondary btn-sm d-flex align-items-center gap-1">
                <span class="material-icons">add</span>
                Pridať recenziu
            </a>
        </div>
                        ...
                        <div class="col flex-shrink-0 mobile-only">
                            <div class="admin-card p-3 flex-column align-items-center text-center position-relative">
                                ...
                                <a href= "#" {{-- "{{ route('review.reply', $review->id) }}"  --}}
                                   class="btn btn-outline-primary btn-sm my-2">Odpovedať</a>
                                <small class="{{ $review->reply ? 'text-success' : 'text-danger' }}">
                                    {{ $review->reply ? 'Zodpovedané.' : 'Čaká na odpoveď' }}
                                </small>
                            </div>
                        </div>
                        {{-- Desktop view --}}
